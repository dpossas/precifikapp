...
class InvalidCredentialsModal extends StatelessWidget {
  const InvalidCredentialsModal({super.key});
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          verticalDivider12,
          Text(
            'Não foi possível acessar o sistema com os dados informados. Revise-os e tente novamente, por favor.',
